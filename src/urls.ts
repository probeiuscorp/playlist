...
export const howToSaveALife = 'lXcX5llJeko';
export const allINeed = 'f-g99Q_R1_k';
export const nothingLeftToLose = 'a7YP4k7rMuc';
export const paradise = '1G4isv_Fylg';
export const dreams = '5oWyMakvQew';
export const freeFalling = '1lWJXDG2i0A';
export const mayerFreeFalling = '20Ov0cDPZy8';
...
export const dontStopBelieving = 'PIFUWHvSixw';
export const livingOnAPrayer = 'YBdyc1WDlBQ';
